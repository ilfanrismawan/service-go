...
// @Produce json
// @Security BearerAuth
// @Param request body dto.ServiceOrderRequest true "Order data"
...
func (h *OrderHandler) CreateOrder(c *gin.Context) {
	...
	if exists {
		...
		var role userDTO.UserRole = userDTO.UserRole(roleVal)
	...
	var req dto.ServiceOrderRequest
...
// @Security BearerAuth
// @Param id path string true "Order ID"
// @Param request body dto.UpdateOrderStatusRequest true "Status update data"
// @Success 200 {object} dto.APIResponse
// @Failure 400 {object} dto.ErrorResponse
// @Failure 401 {object} dto.ErrorResponse
// @Failure 404 {object} dto.ErrorResponse
...
func (h *OrderHandler) ListOrders(c *gin.Context) {
	...
	if statusStr := c.Query("status"); statusStr != "" {
		status := dto.OrderStatus(statusStr)
		filters.Status = &status
	}

	if serviceTypeStr := c.Query("service_type"); serviceTypeStr != "" {
		serviceType := dto.ServiceType(serviceTypeStr)
...
// @Security BearerAuth
// @Param id path string true "Order ID"
// @Param request body dto.ServiceOrderRequest true "Order update data"
// @Success 200 {object} dto.APIResponse
// @Failure 400 {object} dto.ErrorResponse
// @Failure 401 {object} dto.ErrorResponse
// @Failure 404 {object} dto.ErrorResponse
