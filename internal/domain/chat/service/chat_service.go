...
import (
	"context"
	chatRepository "service/internal/domain/chat/repository"
	ordersRepository "service/internal/domain/orders/repository"
...
type ChatService struct {
	...
	orderRepo *ordersRepository.ServiceOrderRepository
}
...
func NewChatService() *ChatService {
	return &ChatService{
		...
		orderRepo: ordersRepository.NewServiceOrderRepository(),
	}
}
