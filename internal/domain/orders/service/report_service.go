...
import (
	"context"
	"fmt"
	branchesRepository "service/internal/domain/branches/repository"
	membershipRepository "service/internal/domain/membership/repository"
	orderRepository "service/internal/domain/orders/repository"
	paymentRepository "service/internal/domain/payments/repository"
	userRepository "service/internal/domain/users/repository"
...
type ReportService struct {
	...
	branchRepo     *branchesRepository.BranchRepository
...
func NewReportService() *ReportService {
	return &ReportService{
		...
		branchRepo:     branchesRepository.NewBranchRepository(),
