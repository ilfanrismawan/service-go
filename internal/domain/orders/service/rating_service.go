...
func (s *RatingService) CreateRating(ctx context.Context, customerID uuid.UUID, req *model.RatingRequest) (*model.RatingResponse, error) {
...
func (s *RatingService) UpdateRating(ctx context.Context, ratingID, customerID uuid.UUID, req *model.RatingRequest) (*model.RatingResponse, error) {
