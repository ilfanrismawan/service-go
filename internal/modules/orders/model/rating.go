...
import (
	...
	branchModel "service-go/internal/modules/branches/model"
)
...
type Rating struct {
	...
	Customer     userModel.User `json:"customer" gorm:"foreignKey:CustomerID"`
	BranchID     *uuid.UUID     `json:"branch_id,omitempty" gorm:"type:uuid"`
	Branch       *branchModel.Branch `json:"branch,omitempty" gorm:"foreignKey:BranchID"`
	TechnicianID *uuid.UUID     `json:"technician_id,omitempty" gorm:"type:uuid"`
	Technician   *userModel.User `json:"technician,omitempty" gorm:"foreignKey:TechnicianID"`
...
type RatingResponse struct {
	...
	Customer      userModel.UserResponse `json:"customer"`
	BranchID     *uuid.UUID               `json:"branch_id,omitempty"`
	Branch       *branchModel.BranchResponse `json:"branch,omitempty"`
	TechnicianID *uuid.UUID               `json:"technician_id,omitempty"`
	Technician   *userModel.UserResponse  `json:"technician,omitempty"`
